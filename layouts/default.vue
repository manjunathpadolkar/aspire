        ...
        <ul>
          ...
          <li class="flex items-center">
            <NuxtLink :to="`/vue-challenge`" class="text-white inline-block">
              ...
              <span
                class="inline-block ml-5 text-ap-font-size-21 text-ap-color-#01D167 open-sans"
                >Vue Challenge</span
              >
            </NuxtLink>
          </li>
          ...
          <li class="mt-6 flex items-center">
            <NuxtLink to="/login" class="text-white">
              ...
              <span
                class="inline-block align-top ml-5 text-ap-color-#01D167 text-ap-font-size-21 open-sans"
                >Logout</span
              >
            </NuxtLink>
          </li>
